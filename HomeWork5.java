...
public static void izbiraneNaOpciqOtMenuto(){
    ...
    System.out.print("\nIzberete opciq ot menuto: ");
        ...
        switch (choice){
            case 1: System.out.print(Arrays.toString(sortInAscendingOrder(array)));
                optionAfterChoosing();
            break;
            case 2: System.out.print(Arrays.toString(sortInDescendingOrder(array)));
                optionAfterChoosing();
            case 3: findElementWithBinarySearch();
            optionAfterChoosing();
            break;
            case 4: System.out.print(Arrays.toString(shuffleArray(array)));
                optionAfterChoosing();
            break;
            case 5: sumOfArrayNumbers(array);
                optionAfterChoosing();
            break;
            case 6: largestNumberInArray(array);
                optionAfterChoosing();
            break;
            case 7: smallestNumberInArray(array);
                optionAfterChoosing();
            break;
            case 8: averageOfArray(array);
            optionAfterChoosing();
            break;
            case 9:
            optionAfterChoosing();
            break;
            case 10: System.out.print(Arrays.toString(reversingNumbersOfArray(array)));
            optionAfterChoosing();
            break;
            case 11: visualisingArray(array);
            optionAfterChoosing();
            break;
            case 12: programExit();
            default: System.out.print("Nevalidna opciq. Opitaite otnovo.");
            optionAfterChoosing();
        }
}
    ...
    public static int[] reversingNumbersOfArray(int[] array){
    ...
    public static void optionAfterChoosing(){
